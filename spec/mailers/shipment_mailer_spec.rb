...
describe Merriweather::ShipmentMailer do
  ...
  it "doesn't include out of stock html span in the email body" do
    Merriweather::Config.allow_backorders = false
    shipment_email = Merriweather::ShipmentMailer.shipped_email(shipment)
  ...
  context "emails must be translatable" do
    context "shipped_email" do
      context "en locale" do
        ...
        specify do
          shipped_email = Merriweather::ShipmentMailer.shipped_email(shipment)
