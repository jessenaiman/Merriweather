...
describe Merriweather::Preference do

  it "should require a key" do
    @preference = Merriweather::Preference.new
    @preference.key = :test
  ...
  describe "type coversion for values" do
    def round_trip_preference(key, value, value_type)
      p = Merriweather::Preference.new
      p.value = value
      p.value_type = value_type
      p.key = key
      p.save

      Merriweather::Preference.find_by_key(key)
    end
  ...
  describe "converting old values" do
    ...
    it "converts true" do
      ...
      Merriweather::Preference.convert_old_value_types(p)
