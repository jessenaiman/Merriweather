...
describe Merriweather::Taxon do
  let(:taxon) { Merriweather::Taxon.new(:name => "Ruby on Rails") }
  ...
  context "set_permalink" do
    ...
    context "with parent taxon" do
      before do
        ...
        Merriweather::Taxon.should_receive(:find).with(123).and_return(mock_model(Merriweather::Taxon, :permalink => "brands"))
      end
