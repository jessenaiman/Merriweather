...
describe Merriweather::Variant do
  ...
  it "recalculates product's count_on_hand when saved" do
    Merriweather::Config[:track_inventory_levels] = true
  ...
  context "on_hand=" do
    ...
    context "when :track_inventory_levels is true" do
      ...
      context "and count is increased" do
        ...
        let(:inventory_unit) { mock_model(Merriweather::InventoryUnit, :state => "backordered") }
