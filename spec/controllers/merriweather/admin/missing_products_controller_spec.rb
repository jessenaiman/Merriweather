...
# the load_resource filter in Merriweather::Admin::ResourceController is prepended to the filter chain
...
describe Merriweather::Admin::ProductsController do
  ...
  it "cannot find a non-existent product" do
    Merriweather_get :edit, :id => "non-existent-product"
    response.should redirect_to(Merriweather.admin_products_path)
