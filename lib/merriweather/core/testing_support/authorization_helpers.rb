module AuthorizationHelpers
  ...
  module Request
    ...
    def stub_authorization!
      before(:all) { Merriweather::Ability.register_ability(AuthorizationHelpers::Request::SuperAbility) }
      after(:all) { Merriweather::Ability.remove_ability(AuthorizationHelpers::Request::SuperAbility) }
    end
  end
end
