##module Merriweather
  class Address < ActiveRecord::Base
    ...
    def self.default
      country = Merriweather::Country.find(Merriweather::Config[:default_country_id]) rescue Merriweather::Country.first
    ...
    private
      ...
      def state_validate
        ...
        return if country.blank? || !Merriweather::Config[:address_requires_state]
