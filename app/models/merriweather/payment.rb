##module Merriweather
  class Payment < ActiveRecord::Base
    ...
    has_many :offsets, :class_name => "Merriweather::Payment", :foreign_key => :source_id, :conditions => "source_type = 'Merriweather::Payment' AND amount < 0 AND state = 'completed'"
    ...
    scope :from_credit_card, lambda { where(:source_type => 'Merriweather::CreditCard') }
    ...
    # see https://github.com/merriweather/merriweather/issues/981
    def build_source
