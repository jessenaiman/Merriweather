module Merriweather
  class Taxon < ActiveRecord::Base
    ...
    belongs_to :taxonomy
    has_and_belongs_to_many :products, :join_table => 'merriweather_products_taxons'
    ...
    has_attached_file :icon,
      ...
      :default_style => :mini,
      :url => '/merriweather/taxons/:id/:style/:basename.:extension',
      :path => ':rails_root/public/merriweather/taxons/:id/:style/:basename.:extension',
