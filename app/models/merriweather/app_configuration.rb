# This is the primary location for defining merriweather preferences
#
# The expectation is that this is created once and stored in
# the merriweather environment
#
# setters:
# a.color = :blue
# a[:color] = :blue
...
module Merriweather
  class AppConfiguration < Preferences::Configuration
    ...
    preference :admin_interface_logo, :string, :default => 'admin/bg/merriweather_50.png'
    ...
    preference :check_for_merriweather_alerts, :boolean, :default => true
    ...
    preference :default_meta_description, :string, :default => 'merriweather demo site'
    preference :default_meta_keywords, :string, :default => 'merriweather, demo'
    preference :default_seo_title, :string, :default => ''
    preference :dismissed_merriweather_alerts, :string, :default => ''
    preference :last_check_for_merriweather_alerts, :string, :default => nil
    preference :layout, :string, :default => 'merriweather/layouts/merriweather_application'
    preference :logo, :string, :default => 'admin/bg/merriweather_50.png'
    ...
    preference :site_name, :string, :default => 'merriweather Demo Site'
    preference :site_url, :string, :default => 'demo.merriweathercommerce.com'
    ...
    preference :attachment_default_url, :string, :default => '/merriweather/products/:id/:style/:basename.:extension'
    preference :attachment_path, :string, :default => ':rails_root/public/merriweather/products/:id/:style/:basename.:extension'
    preference :attachment_url, :string, :default => '/merriweather/products/:id/:style/:basename.:extension'
    ...
    # searcher_class allows merriweather extension writers to provide their own Search class
    def searcher_class
      @searcher_class ||= Merriweather::Core::Search::Base
    end
