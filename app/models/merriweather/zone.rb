  ...
  class Zone < ActiveRecord::Base
    ...
    def include?(address)
      ...
      members.any? do |zone_member|
        ...
        when 'Merriweather::Country'
          zone_member.zoneable_id == address.country_id
        when 'Merriweather::State'
    ...
    private
      ...
      def remove_defunct_members
        zone_members.each do |zone_member|
          zone_member.destroy if zone_member.zoneable_id.nil? || zone_member.zoneable_type != "Merriweather::#{kind.capitalize}"
        end
      end
