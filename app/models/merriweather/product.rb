module Merriweather
  class Product < ActiveRecord::Base
    ...
    has_and_belongs_to_many :taxons, :join_table => 'merriweather_products_taxons'
  ...
  #  has_many :variant_images, :source => :images, :through => :variants_including_master, :order => :position
    ...
    attr_accessible :content, :gemm, :image, :name, :band_id, :genre_id, :heading, :product_type_id, 
                    :meta_words, :price, :sku, :deleted_at, :prototype_id,
    ...
    def variants_with_only_master
      ActiveSupport::Deprecation.warn("[merriweather] Merriweather::Product#variants_with_only_master will be deprecated in Merriweather 1.3. Please use Merriweather::Product#master instead.")
      master
    end
   ...
   require_dependency 'merriweather/product/scopes'
end
