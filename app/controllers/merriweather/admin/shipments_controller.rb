    ...
    class ShipmentsController < Admin::BaseController
      ...
      def update
        ...
        if shipment.update_attributes params[:shipment]
          ...
          order.special_instructions = params[:shipment][:special_instructions] if Config[:shipping_instructions]
      ...
      def build_shipment
        ...
        @shipment.address ||= Address.new(:country_id => Config[:default_country_id])
