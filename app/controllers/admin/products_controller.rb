    ...
    class ProductsController < ResourceController
      ...
      protected
        ...
        def collection
          ...
          unless request.xhr?
            ...
            @collection = @search.result.
              ...
              page(params[:page]).
              per(Merriweather::Config[:admin_products_per_page])
            ...
            if params[:q][:s].include?("master_price")
              ...
              @collection = @collection.group("merriweather_variants.price")
            end
          else
        ...
        def create_before
          ...
          @prototype = Merriweather::Prototype.find(params[:product][:prototype_id])
        end
