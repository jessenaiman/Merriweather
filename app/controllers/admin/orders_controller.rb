#module Merriweather
  module Admin
    class OrdersController < Admin::BaseController
      require 'merriweather/core/gateway_error'
      ...
      def index
        params[:q] ||= {}
        params[:q][:completed_at_not_null] ||= '1' if Config[:show_only_complete_orders_by_default]
        ...
        @orders = @search.result(:distinct => true).includes([:user, :shipments, :payments]).page(params[:page]).per(Config[:orders_per_page])
