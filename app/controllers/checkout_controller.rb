#module Merriweather
  ...
  class CheckoutController < BaseController
    ...
    rescue_from Merriweather::Core::GatewayError, :with => :rescue_from_merriweather_gateway_error
    ...
    def update
      if @order.update_attributes(object_params)
        fire_event('merriweather.checkout.update')
    ...
    private
      ...
      def raise_insufficient_quantity
        flash[:error] = t(:merriweather_inventory_error_flash_for_insufficient_quantity)
      ...
      def rescue_from_merriweather_gateway_error
        flash[:error] = t(:merriweather_gateway_error_flash_for_checkout)
        render :edit
      end
  end
#end
